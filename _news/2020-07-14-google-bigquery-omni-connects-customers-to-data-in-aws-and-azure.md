...
related:
  - title: "BigQuery Omni pulls Google, AWS, and Azure analytics into one UI"
    excerpt: "Google has launched an early version of BigQuery Omni, it’s new analytics tool that lets users access and view data across Google Cloud and Amazon Web Services without leaving the Big Query UI. Powered by Google Anthos,"
    publishedDateTime: 2020-07-14T12:33:00Z
    webUrl: "https://www.itpro.co.uk/data-insights/sql/356444/bigquery-omni-pulls-google-aws-and-azure-analytics-into-one-ui"
    ampWebUrl: "https://www.itpro.co.uk/data-insights/sql/356444/bigquery-omni-pulls-google-aws-and-azure-analytics-into-one-ui?amp"
    ...
    quality: 89
    images:
      - url: "https://media.itpro.co.uk//image/upload/v1594727792/itpro/BigQuery_Omni_google_press.png"
        width: 960
        height: 540
        isCached: true
  - title: "Google Cloud’s new BigQuery Omni will let developers query data in GCP, AWS and Azure"
    excerpt: "For example, they use the built-in machine learning capabilities to run real ... This also explains why BigQuery Omni isn’t available for Azure yet, given that Anthos for Azure is still in ..."
